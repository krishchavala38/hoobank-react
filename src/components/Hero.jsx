  ...
  (
    ...
    ${styles.paddingY}`}>
       ...
       flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5 mb-5 `}>Our team of experts uses a methodology to identify the credit cards most likely to fit your needs.
       ...
       <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        white__gradient"/>
        <div className="absolute z-[0] w-[50%] h-[50%] bottom-20 
        blue__gradient
        "/>
       </div>
